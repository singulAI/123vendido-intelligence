...
import type { ApiResponse } from "../../../../backend/client-sdk-typescript/src";
...
export async function request<T = unknown>(
  ...
  try {
    ...
    if (isApiResponse<T>(payload)) {
      if (!payload.success) {
        throw new ApiError("Backend returned an unsuccessful ApiResponse.", res.status, payload.errors);
      }
